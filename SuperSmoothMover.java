...
public abstract class SuperSmoothMover extends Actor
{
    ...
    /**
     * Set the transparency of an image, as a percentage
     */
    public void setTransparency(double percentage)
    {
        getImage().setTransparency((int) (255.0 * percentage)); // 255 = "opaque", 0 = "transparent"
    }
