    ...
    private void awardRewards() {
        if (getWorld() instanceof MyWorld) {
            ...
            if (direction == 1) { // If side 1 unit died, award to side 2
                world.addGold(2, getGoldReward()* age);
                world.addXP(2, getXPReward()*age);
            } else { // If side 2 unit died, award to side 1
                world.addGold(1, getGoldReward()*age);
                world.addXP(1, getXPReward()*age);
            }
        }
    }
